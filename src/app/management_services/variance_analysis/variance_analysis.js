(function(){
	...
	.controller('VarianceAnalysis.ListController', ['$rootScope', '$scope', '$filter', 'varianceAnalysis', '$state', '$mixpanel', 'HRAPI_CONF', function($rootScope, $scope, $filter, varianceAnalysis, $state, $mixpanel, HRAPI_CONF){
