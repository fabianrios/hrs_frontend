(function(){
	...
	.controller('HistoricalSalaries.ListController', ['$rootScope', '$scope', '$filter', 'historicalSalaries', '$state', '$mixpanel', function($rootScope, $scope, $filter, historicalSalaries, $state, $mixpanel){
