(function(){
	...
	.controller('Absences.ListController', ['$rootScope', '$scope', '$filter', 'absences', '$state', '$mixpanel', 'HRAPI_CONF', function($rootScope, $scope, $filter, absences, $state, $mixpanel, HRAPI_CONF){
