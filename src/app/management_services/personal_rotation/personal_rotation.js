(function(){
	...
	.controller('PersonalRotation.ListController', ['$rootScope', '$scope', 'personalRotation', '$state', '$mixpanel', 'HRAPI_CONF', function($rootScope, $scope, personalRotation, $state, $mixpanel, HRAPI_CONF){
